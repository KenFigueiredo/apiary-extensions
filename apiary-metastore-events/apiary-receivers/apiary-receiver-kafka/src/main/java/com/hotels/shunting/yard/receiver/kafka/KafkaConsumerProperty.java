...
public enum KafkaConsumerProperty implements MessageProperty {
  TOPIC("topic", null),
  ...
  KEY_SERIALIZER("key.serializer", "org.apache.kafka.common.serialization.LongSerializer"),
  VALUE_SERIALIZER("value.serializer", "org.apache.kafka.common.serialization.ByteArraySerializer");

  private static final String PROPERTY_PREFIX = "event.receiver.kafka.";
